...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($data['image_hover'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "product SET image_hover = '" . $this->db->escape($data['image_hover']) . "' WHERE product_id = '" . (int)$product_id . "'");
		}
		...
		if (isset($data['product_option'])) {
			foreach ($data['product_option'] as $product_option) {
				if ($product_option['type'] == 'select' || $product_option['type'] == 'color' || $product_option['type'] == 'color' || $product_option['type'] == 'color' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
	...
	public function editProduct($product_id, $data) {
		...
		if (isset($data['product_option'])) {
			foreach ($data['product_option'] as $product_option) {
				if ($product_option['type'] == 'select' || $product_option['type'] == 'color' || $product_option['type'] == 'color' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
					if (isset($product_option['product_option_value'])) {
