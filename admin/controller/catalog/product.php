...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['image_hover'])) {
			$data['image_hover'] = $this->request->post['image_hover'];
		} elseif (!empty($product_info)) {
			$data['image_hover'] = $product_info['image_hover'];
		} else {
			$data['image_hover'] = '';
		}
		...
		if (isset($this->request->post['image_hover']) && is_file(DIR_IMAGE . $this->request->post['image_hover'])) {
			$data['thumb_hover'] = $this->model_tool_image->resize($this->request->post['image_hover'], 100, 100);
		} elseif (!empty($product_info) && is_file(DIR_IMAGE . $product_info['image_hover'])) {
			$data['thumb_hover'] = $this->model_tool_image->resize($product_info['image_hover'], 100, 100);
		} else {
