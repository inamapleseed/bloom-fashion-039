						...
						<div class="tab-pane" id="tab-image">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											<td class="text-left">Hover Image</td>
										</tr>
									</thead>
									
									<tbody>
										<tr>
											<td class="text-left"><a href="" id="thumb-image_hover" data-toggle="image" class="img-thumbnail"><img src="<?= $thumb_hover; ?>" alt="" title="" data-placeholder="<?= $placeholder; ?>" /></a><input type="hidden" name="image_hover" value="<?= $image_hover; ?>" id="input-image_hover" /></td>
										</tr>
									</tbody>
								</table>
							</div>
