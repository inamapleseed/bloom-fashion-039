              ...
              <tr id="option-value-row<?php echo $option_value_row; ?>">
                ...
                <td>
                  ...
                  <div class="input-group color-picker">
                      <input type="text" name="option_value[<?php echo $option_value_row; ?>][color]" class=" form-control" value="<?php echo $option_value['color']; ?>">
...
$('select[name=\'type\']').on('change', function() {
  if (this.value == 'select' || this.value == 'color' || this.value == 'radio' || this.value == 'checkbox' || this.value == 'image') {
    $('#option-value').show();
  } else {
    $('#option-value').hide();
  }
...
function addOptionValue() {
  ...
  <?php } ?>
  html += '  </td>';
  html += '<td><div class="input-group color-picker"><input type="text" name="option_value[' + option_value_row + '][color]" class=" form-control" value="#ffffff"><span class="input-group-addon"><i></i></span></div></td>';
