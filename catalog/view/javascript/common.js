...
$(document).ready(function() {
	...
	$(document).on("click", ".color-dot", function() {
        ...
        var title_target = $(this).data('title_link');
        var link_overide = $(this).data('href');
        var btn_target = $(this).data('btn_target');
        var option_value = $(this).data('option_value');
        
        var target2 = $(this).data('target2');
        var img_src2 = $(this).data('img2');
        ...
        if(img_src2){
        	$(target2).attr("src",img_src2);
        	$(target2).fadeIn();
        }
        $(target).parent().attr("href", link_overide);
        $(title_target).attr("href", link_overide);
        $(btn_target).attr("href", link_overide);
        $('.color-dot').removeClass('active');
        $(this).addClass('active');

    });
    $('.color-options span:first-of-type').click();
    $('.color-options span:first-of-type').addClass('active');
