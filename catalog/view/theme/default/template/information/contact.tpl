			...
			<div class="pd-b30">
				<form id="contact-us-form" action="<?= $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
					<div class="contact-body">
						...
						<div class="form-group required">
							<input type="tel" name="telephone" value="<?= $telephone; ?>" id="input-telephone" class="form-control input-number" placeholder="Number" />
						...
						<div class="form-group required">
							<input type="text" name="subject" value="<?= $subject; ?>" id="input-subject" class="form-control" placeholder="Enquiry Type" />
						...
						<div class="form-group required">
							<textarea name="enquiry" rows="6" id="input-enquiry" class="form-control" placeholder="<?= $entry_enquiry; ?>"><?= $enquiry; ?></textarea>
