      	...
      	setTimeout(function(){ 
		  	<?php if ($vertical_slider) { ?>
		  		$('.product-image-additional').slick({
		  			...
		  			infinite: false,
		  			vertical: true,
		  			prevArrow: "<div class='pointer slick-nav left prev'><div class=''><img src='image/catalog/slicing/general/up-arrow.png' alt='arrow' class='arrow'/></div></div>",
		  			nextArrow: "<div class='pointer slick-nav right next'><div class=''><img src='image/catalog/slicing/general/down-arrow.png' alt='arrow' class='arrow'/></div></div>",
		  		});
		  	<?php } else { ?>
