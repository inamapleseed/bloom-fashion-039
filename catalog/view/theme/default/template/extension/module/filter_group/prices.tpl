<?php if($active){ ?>
	<div id="side-price">
		<div class="list-group-item item-header"><?= $heading_title ?>&nbsp;<?= $left_symbol ? $left_symbol : ''?></div>
		<div class="list-group-item">
			<div class="price-container" style="padding-bottom: 10px">
            ...
            <span id="min" style="position: absolute;"></span>
            <span id="max" style="position: absolute; right: 0; left: auto"></span>
